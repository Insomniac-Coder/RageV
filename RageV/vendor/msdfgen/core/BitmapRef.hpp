...
struct BitmapSection {
    ...
    inline operator BitmapConstSection<T, N>() const {
        return BitmapConstSection<T, N>(pixels, width, height, rowStride, yOrientation);
    }
...
struct BitmapConstRef {
    ...
    inline operator BitmapConstSection<T, N>() const {
        return BitmapConstSection<T, N>(pixels, width, height, yOrientation);
    }
...
struct BitmapRef {
    ...
    inline operator BitmapConstRef<T, N>() const {
        return BitmapConstRef<T, N>(pixels, width, height, yOrientation);
    }

    inline operator BitmapSection<T, N>() const {
        return BitmapSection<T, N>(pixels, width, height, yOrientation);
    }
