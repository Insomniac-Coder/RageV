...
| RT-8 | 🔨 **jobs 2 and 3 done, job 1 built and off 2026-09-09** — the layer, its motion, its averaging and its mirror ray are on the contract; the direct light works and is measurably cleaner but costs 0.86 M rays too many | ~1 d left | **high** | the water on the G-buffer |
