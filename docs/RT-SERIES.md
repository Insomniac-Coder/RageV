...
| RT-8 | 🔨 **jobs 3 done 2026-09-09** — the layer, its motion and its averaging are on the contract; the light and the rays open | 2-3 d left | **high** | the water on the G-buffer |
